---
title: "Harvardx Capstone Project 2"
...
```{r variable selection, echo = TRUE, message = FALSE, warning = FALSE, eval = TRUE}
...
```{r Decision Tree model, echo = TRUE, message = FALSE, warning = FALSE, eval = TRUE}
